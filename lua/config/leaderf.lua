...
vim.api.nvim_set_keymap('n', '<leader>fb', ':<C-U><C-R>=printf("Leaderf buffer %s", "")<CR><CR>',
    { noremap = true, silent = true })
-- open a bufTag search
vim.api.nvim_set_keymap('n', '<leader>fh', ':<C-U><C-R>=printf("Leaderf bufTag %s", "")<CR><CR>',
    { noremap = true, silent = true })
-- open a function search
vim.api.nvim_set_keymap('n', '<leader>fc', ':<C-U><C-R>=printf("Leaderf function %s", "")<CR><CR>',
    { noremap = true, silent = true })
-- open a line search
vim.api.nvim_set_keymap('n', '<leader>fl', ':<C-U><C-R>=printf("Leaderf line %s", "")<CR><CR>',
    { noremap = true, silent = true })
-- open a mru
vim.api.nvim_set_keymap('n', '<leader>fm', ':<C-U><C-R>=printf("Leaderf mru %s", "")<CR><CR>',
    { noremap = true, silent = true })
-- Search for the word under the cursor in the current buffer using rg.
vim.api.nvim_set_keymap('n', '<C-B>', ':<C-U><C-R>=printf("Leaderf! rg --current-buffer -e %s ", expand("<cword>"))<CR>',
    { noremap = true, silent = true })
-- Search for the word under the cursor in the entire project using rg.
vim.api.nvim_set_keymap('n', '<C-F>', ':<C-U><C-R>=printf("Leaderf! rg -e %s ", expand("<cword>"))<CR>',
    { noremap = true, silent = true })
